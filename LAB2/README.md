...
For this lab, you will be working in groups of 2-3 people.
You should *each* submit a copy of your code (which can/should be identical) and you should jointly submit one version of the written component of the lab via Canvas.
